...
public class CustomProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            strokeWidth = typedArray.getDimension(R.styleable.CustomProgressBar_progressBarThickness, strokeWidth);
            progressing = typedArray.getFloat(R.styleable.CustomProgressBar_progressing, progressing);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float angle = 360 * progressing / max;
    ...
    /**
     * Set the progressing with an animation.
     * Note that the {@link android.animation.ObjectAnimator} Class automatically set the progress
     * so don't call the {@link CustomProgressBar#setProgressing(float)} directly within this method.
     *
     * @param progressing The progressing it should animate to it.
     */
    public void setProgressWithAnimation(float progressing) {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(this, "progressing", progressing);
